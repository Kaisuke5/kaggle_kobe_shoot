...
def NN_mappedvec(df):
    ...
    clf = model.shoot_network(2500,gpu=0)
    clf.fit(f(train_x_vec), train_y_vec,n_epoch=150,batchsize=500)
...
if __name__ == "__main__":
    ...
    predict_y = NN_mappedvec(df)
    makesubmission(predict_y,savename='submission_nn.csv')
